...
Program *Parser::parseProgram() { return new Program(parseBody()); }
...
Stm *Parser::parseStatement() {
  ...
  if (match(Token::ID)) {
    ...
    if (!match(Token::COLON))
      parserError("Esperaba COLON en for");
    e = parseExp();
...
Exp *Parser::parseExp() { return parseBExp(); }
